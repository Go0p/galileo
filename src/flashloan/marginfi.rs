...
static SYSTEM_PROGRAM_ID: Lazy<Pubkey> =
    Lazy::new(|| parse_pubkey("11111111111111111111111111111111"));

const ACCOUNT_INITIALIZE_DISCRIMINATOR: [u8; 8] = [43, 78, 61, 255, 148, 52, 249, 154];
const BEGIN_DISCRIMINATOR: [u8; 8] = [14, 131, 33, 220, 81, 186, 180, 107];
...
fn build_end(
    ...
    let mut accounts = Vec::with_capacity(2 + remaining.len() + 1);
...
fn parse_pubkey(raw: &str) -> Pubkey {
