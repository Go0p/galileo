...
mod tests {
    ...
    fn encode_base64_transaction(tx: &VersionedTransaction) -> Result<String, EncodeTxError> {
        let bytes = encode_to_vec(tx, super::bincode_config()).map_err(EncodeTxError::Bincode)?;
