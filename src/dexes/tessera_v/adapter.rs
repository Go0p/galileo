...
#[derive(Default)]
pub struct TesseraVAdapter;

impl TesseraVAdapter {
    pub fn shared() -> &'static Self {
        &ADAPTER
    }
}

static ADAPTER: TesseraVAdapter = TesseraVAdapter;

impl DexMarketMeta for TesseraVMarketMeta {
...
impl DexMetaProvider for TesseraVAdapter {
    type MarketMeta = TesseraVMarketMeta;
...
impl SwapAccountAssembler for TesseraVAdapter {
    type MarketMeta = TesseraVMarketMeta;
