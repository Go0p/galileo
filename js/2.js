...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[6690], {
    40476: (e, t, r) => {
        ...
        r.d(t, {
            ...
            AddressLookupTableInstruction: () => rS,
            AddressLookupTableProgram: () => rI,
            Authorized: () => rR,
            BLOCKHASH_CACHE_TIMEOUT_MS: () => eF,
            BPF_LOADER_DEPRECATED_PROGRAM_ID: () => L,
            BPF_LOADER_PROGRAM_ID: () => ex,
            BpfLoader: () => eL,
            COMPUTE_BUDGET_INSTRUCTION_LAYOUTS: () => rv,
            ComputeBudgetInstruction: () => r_,
            ComputeBudgetProgram: () => rA,
            Connection: () => rf,
            Ed25519Program: () => rE,
            Enum: () => W,
            EpochSchedule: () => eY,
            FeeCalculatorLayout: () => eA,
            Keypair: () => rk,
            LAMPORTS_PER_SOL: () => r1,
            LOOKUP_TABLE_INSTRUCTION_LAYOUTS: () => rw,
            Loader: () => eC,
            Lockup: () => rC,
            MAX_SEED_LENGTH: () => N,
            Message: () => ee,
            ...
            SOLANA_SCHEMA: () => T,
            STAKE_CONFIG_ID: () => rO,
            STAKE_INSTRUCTION_LAYOUTS: () => rL,
            SYSTEM_INSTRUCTION_LAYOUTS: () => eN,
            ...
            Secp256k1Program: () => rN,
            SendTransactionError: () => ef,
            SolanaJSONRPCError: () => ew,
            SolanaJSONRPCErrorCode: () => ek,
            StakeAuthorizationLayout: () => rK,
            StakeInstruction: () => rx,
            StakeProgram: () => rz,
            Struct: () => B,
            SystemInstruction: () => eT,
            SystemProgram: () => eO,
            Transaction: () => ea,
            ...
            TransactionMessage: () => eo,
            TransactionStatus: () => ei,
            VALIDATOR_INFO_KEY: () => rU,
            ...
            VoteAccount: () => rJ,
            VoteAuthorizationLayout: () => rH,
            VoteInit: () => rY,
            VoteInstruction: () => rq,
            VoteProgram: () => rj,
            clusterApiUrl: () => rQ,
            sendAndConfirmRawTransaction: () => r0,
            sendAndConfirmTransaction: () => eS
        });
        var i, s, n = r(91015), a = r(56349), o = r(36105), c = r.n(o), u = r(83291), l = r.n(u), d = r(30680), h = r(22367), g = r(95817), p = r(9599), m = r(56274), y = r(17071), b = r.n(y), f = r(12213), k = r(87432), w = r(15987);
        let S = a.ev.utils.randomPrivateKey
          , I = () => {
            let e = a.ev.utils.randomPrivateKey()
              , t = _(e)
              , r = new Uint8Array(64);
            return r.set(e),
            r.set(t, 32),
        ...
        function v(e) {
            try {
                return a.ev.ExtendedPoint.fromHex(e),
                !0
            } catch {
                return !1
            }
        }
        let A = (e, t) => a.ev.sign(e, t.slice(0, 32))
          , P = a.ev.verify
          , E = e => n.Buffer.isBuffer(e) ? e : e instanceof Uint8Array ? n.Buffer.from(e.buffer, e.byteOffset, e.byteLength) : n.Buffer.from(e);
        class B {
            constructor(e) {
                Object.assign(this, e)
            }
            encode() {
                return n.Buffer.from((0,
                h.serialize)(T, this))
            }
            static decode(e) {
                return (0,
                h.deserialize)(T, this, e)
            }
            static decodeUnchecked(e) {
                return (0,
                h.deserializeUnchecked)(T, this, e)
            }
        }
        class W extends B {
            constructor(e) {
        ...
        class C extends B {
            ...
            static async createWithSeed(e, t, r) {
                let i = n.Buffer.concat([e.toBuffer(), n.Buffer.from(t), r.toBuffer()]);
                return new C((0,
                d.sc)(i))
            }
        ...
        let L = new C("BPFLoader1111111111111111111111111111111111")
          , K = 1232
          , z = 127
          , Y = 64;
        ...
        let U = (e="publicKey") => g.av(32, e)
          , M = (e="signature") => g.av(64, e)
          , V = (e="string") => {
            let t = g.w3([g.DH("length"), g.DH("lengthPadding"), g.av(g.cY(g.DH(), -8), "chars")], e)
              , r = t.decode.bind(t)
              , i = t.encode.bind(t);
            ...
            t.alloc = e => g.DH().span + g.DH().span + n.Buffer.from(e, "utf8").length,
            t
        }
        ;
        function $(e) {
        ...
        class G {
            ...
            getMessageComponents() {
                ...
                return [n, [...t.map( ([e]) => new C(e)), ...r.map( ([e]) => new C(e)), ...i.map( ([e]) => new C(e)), ...s.map( ([e]) => new C(e))]]
            }
            extractTableLookup(e) {
                let[t,r] = this.drainKeysFoundInLookupTable(e.state.addresses, e => !e.isSigner && !e.isInvoked && e.isWritable)
                  , [i,s] = this.drainKeysFoundInLookupTable(e.state.addresses, e => !e.isSigner && !e.isInvoked && !e.isWritable);
            ...
            drainKeysFoundInLookupTable(e, t) {
                ...
                for (let[s,n] of this.keyMetaMap.entries())
                    if (t(n)) {
                        ...
                        n >= 0 && (J(n < 256, "Max lookup table index exceeded"),
                        r.push(n),
                        i.push(t),
        ...
        class ee {
            ...
            static compile(e) {
                let[t,r] = G.compile(e.instructions, e.payerKey).getMessageComponents()
            ...
            serialize() {
                ...
                let r = this.instructions.map(e => {
                  ...
                  , i = [];
                F(i, r.length);
                let s = n.Buffer.alloc(K);
                n.Buffer.from(i).copy(s);
                let a = i.length;
                r.forEach(e => {
                    let t = g.w3([g.u8("programIdIndex"), g.av(e.keyIndicesCount.length, "keyIndicesCount"), g.O6(g.u8("keyIndex"), e.keyIndices.length, "keyIndices"), g.av(e.dataLength.length, "dataLength"), g.O6(g.u8("userdatum"), e.data.length, "data")]).encode(e, s, a);
                    a += t
                }
                ),
                s = s.slice(0, a);
                let o = g.w3([g.av(1, "numRequiredSignatures"), g.av(1, "numReadonlySignedAccounts"), g.av(1, "numReadonlyUnsignedAccounts"), g.av(t.length, "keyCount"), g.O6(U("key"), e, "keys"), U("recentBlockhash")])
                  , c = {
            ...
            static from(e) {
                ...
                return new ee({
                    ...
                    recentBlockhash: l().encode(n.Buffer.from(c)),
                    accountKeys: o,
                    instructions: d
                })
            }
        ...
        class et {
            ...
            static compile(e) {
                ...
                let[s,n] = t.getMessageComponents()
                  , a = new j(n,i).compileInstructions(e.instructions);
                return new et({
                    header: s,
                    staticAccountKeys: n,
                    recentBlockhash: e.recentBlockhash,
            ...
            serialize() {
                ...
                let i = this.serializeAddressTableLookups()
                  , s = [];
                F(s, this.addressTableLookups.length);
                let n = g.w3([g.u8("prefix"), g.w3([g.u8("numRequiredSignatures"), g.u8("numReadonlySignedAccounts"), g.u8("numReadonlyUnsignedAccounts")], "header"), g.av(e.length, "staticAccountKeysLength"), g.O6(U(), this.staticAccountKeys.length, "staticAccountKeys"), U("recentBlockhash"), g.av(r.length, "instructionsLength"), g.av(t.length, "serializedInstructions"), g.av(s.length, "addressTableLookupsLength"), g.av(i.length, "serializedAddressTableLookups")])
                  , a = new Uint8Array(K)
                  , o = n.encode({
                    prefix: 128,
                    header: this.header,
            ...
            serializeInstructions() {
                ...
                for (let r of this.compiledInstructions) {
                    ...
                    let s = [];
                    F(s, r.data.length);
                    let n = g.w3([g.u8("programIdIndex"), g.av(i.length, "encodedAccountKeyIndexesLength"), g.O6(g.u8(), r.accountKeyIndexes.length, "accountKeyIndexes"), g.av(s.length, "encodedDataLength"), g.av(r.data.length, "data")]);
                    e += n.encode({
            ...
            serializeAddressTableLookups() {
                ...
                for (let r of this.addressTableLookups) {
                    ...
                    let s = [];
                    F(s, r.readonlyIndexes.length);
                    let n = g.w3([U("accountKey"), g.av(i.length, "encodedWritableIndexesLength"), g.O6(g.u8(), r.writableIndexes.length, "writableIndexes"), g.av(s.length, "encodedReadonlyIndexesLength"), g.O6(g.u8(), r.readonlyIndexes.length, "readonlyIndexes")]);
                    e += n.encode({
            ...
            static deserialize(e) {
                ...
                J(0 === i, `Expected versioned message with version 0 but found version ${i}`);
                let s = {
                  ...
                  , a = $(t);
                for (let e = 0; e < a; e++)
                    n.push(new C(Q(t, 0, O)));
                let o = l().encode(Q(t, 0, O))
                  , c = $(t)
                  , u = [];
                for (let e = 0; e < c; e++) {
                    let e = Z(t)
        ...
        class ea {
            ...
            add(...e) {
                ...
                return e.forEach(e => {
                    "instructions"in e ? this.instructions = this.instructions.concat(e.instructions) : "data"in e && "programId"in e && "keys"in e ? this.instructions.push(e) : this.instructions.push(new en(e))
                }
                ),
                this
            }
            compileMessage() {
                ...
                s.forEach(e => {
                    ...
                    r > -1 ? (n[r].isWritable = n[r].isWritable || e.isWritable,
                    n[r].isSigner = n[r].isSigner || e.isSigner) : n.push(e)
                }
                ),
                n.sort(function(e, t) {
                ...
                return p.forEach(e => {
                    J(e.programIdIndex >= 0),
                    e.accounts.forEach(e => J(e >= 0))
                }
                ),
                new ee({
                    header: {
            ...
            _compile() {
                ...
                return this.signatures.length === t.length && this.signatures.every( (e, r) => t[r].equals(e.publicKey)) ? e : (this.signatures = t.map(e => ({
                    signature: null,
                    publicKey: e
                })),
                e)
            ...
            _getMessageSignednessErrors(e, t) {
                ...
                for (let {signature: i, publicKey: s} of this.signatures)
                    null === i ? t && (r.missing ||= []).push(s) : P(i, e, s.toBytes()) || (r.invalid ||= []).push(s);
...
Missing signature for public key${1 === e.missing.length ? "" : "(s)"} [\`${e.missing.map(e => e.toBase58()).join("`, `")}\`].`),
            ...
            _serialize(e) {
                ...
                let i = r.length + 64 * t.length + e.length
                  , s = n.Buffer.alloc(i);
                return J(t.length < 256),
                n.Buffer.from(r).copy(s, 0),
                t.forEach( ({signature: e}, t) => {
                    null !== e && (J(64 === e.length, "signature has invalid length"),
                    n.Buffer.from(e).copy(s, r.length + 64 * t))
                }
                ),
                e.copy(s, r.length + 64 * t.length),
                J(s.length <= K, `Transaction too large: ${s.length} > ${K}`),
                s
            }
            get keys() {
                return J(1 === this.instructions.length),
            ...
            static from(e) {
                ...
                for (let e = 0; e < r; e++) {
                    let e = Q(t, 0, Y);
                    i.push(l().encode(n.Buffer.from(e)))
                }
                return ea.populate(ee.from(t), i)
            }
            static populate(e, t=[]) {
                let r = new ea;
        ...
        class eo {
            ...
            static decompile(e, t) {
                let {header: r, compiledInstructions: i, recentBlockhash: s} = e
                  , {numRequiredSignatures: n, numReadonlySignedAccounts: a, numReadonlyUnsignedAccounts: o} = r
                  , c = n - a;
                J(c > 0, "Message header is invalid");
                let u = e.staticAccountKeys.length - n - o;
                ...
                for (let e of i) {
                    ...
                    for (let i of e.accountKeyIndexes) {
                        ...
                        e = i < n ? i < c : i < l.staticAccountKeys.length ? i - n < u : i - l.staticAccountKeys.length < l.accountKeysFromLookups.writable.length,
                        t.push({
                            pubkey: s,
        ...
        class ec {
            ...
            constructor(e, t) {
                ...
                this.message = void 0,
                void 0 !== t)
                    J(t.length === e.header.numRequiredSignatures, "Expected signatures length to be equal to the number of required signatures"),
                    this.signatures = t;
                else {
                    let t = [];
            ...
            serialize() {
                ...
                let r = g.w3([g.av(t.length, "encodedSignaturesLength"), g.O6(M(), this.signatures.length, "signatures"), g.av(e.length, "serializedMessage")])
            ...
            sign(e) {
                ...
                for (let i of e) {
                    ...
                    J(e >= 0, `Cannot sign with non signer key ${i.publicKey.toBase58()}`),
            ...
            addSignature(e, t) {
                ...
                J(r >= 0, `Can not add signature; \`${e.toBase58()}\` is not required to sign this transaction`),
                this.signatures[r] = t
            }
        }
        let eu = new C("SysvarC1ock11111111111111111111111111111111")
          , el = new C("SysvarEpochSchedu1e111111111111111111111111")
          , ed = new C("Sysvar1nstructions1111111111111111111111111")
          , eh = new C("SysvarRecentB1ockHashes11111111111111111111")
          , eg = new C("SysvarRent111111111111111111111111111111111")
          , ep = new C("SysvarRewards111111111111111111111111111111")
          , em = new C("SysvarS1otHashes111111111111111111111111111")
          , ey = new C("SysvarS1otHistory11111111111111111111111111")
          , eb = new C("SysvarStakeHistory1111111111111111111111111");
...
${JSON.stringify(i.slice(-10), null, 2)}. ` : "", a = "\nCatch the `SendTransactionError` and call `getLogs()` on it for full details.";
                switch (e) {
                case "send":
                    s = `Transaction ${t} resulted in an error. 
${r}. ` + n + a;
                    break;
                case "simulate":
                    s = `Simulation failed. 
...
` + n + a;
        ...
        let eA = g.I0("lamportsPerSignature")
          , eP = g.w3([g.DH("version"), g.DH("state"), U("authorizedPubkey"), U("nonce"), g.w3([eA], "feeCalculator")])
          , eE = eP.span;
        class eB {
            constructor(e) {
        ...
        class eT {
            ...
            static decodeInstructionType(e) {
                ...
                let r = g.DH("instruction").decode(e.data);
                for (let[e,i] of Object.entries(eN))
                    if (i.index == r) {
                        t = e;
                        break
                    }
            ...
            static decodeCreateAccount(e) {
                ...
                let {lamports: t, space: r, programId: i} = ev(eN.Create, e.data);
                return {
            ...
            static decodeTransfer(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 2);
                let {lamports: t} = ev(eN.Transfer, e.data);
                return {
                    fromPubkey: e.keys[0].pubkey,
            ...
            static decodeTransferWithSeed(e) {
                ...
                let {lamports: t, seed: r, programId: i} = ev(eN.TransferWithSeed, e.data);
                return {
                    fromPubkey: e.keys[0].pubkey,
            ...
            static decodeAllocate(e) {
                ...
                let {space: t} = ev(eN.Allocate, e.data);
                return {
            ...
            static decodeAllocateWithSeed(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 1);
                let {base: t, seed: r, space: i, programId: s} = ev(eN.AllocateWithSeed, e.data);
                return {
                    accountPubkey: e.keys[0].pubkey,
                    basePubkey: new C(t),
                    seed: r,
            ...
            static decodeAssign(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 1);
                let {programId: t} = ev(eN.Assign, e.data);
                return {
                    accountPubkey: e.keys[0].pubkey,
                    programId: new C(t)
                }
            ...
            static decodeAssignWithSeed(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 1);
                let {base: t, seed: r, programId: i} = ev(eN.AssignWithSeed, e.data);
                return {
                    accountPubkey: e.keys[0].pubkey,
                    basePubkey: new C(t),
                    seed: r,
            ...
            static decodeCreateWithSeed(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 2);
                let {base: t, seed: r, lamports: i, space: s, programId: n} = ev(eN.CreateWithSeed, e.data);
                return {
                    fromPubkey: e.keys[0].pubkey,
                    newAccountPubkey: e.keys[1].pubkey,
                    basePubkey: new C(t),
            ...
            static decodeNonceInitialize(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 3);
                let {authorized: t} = ev(eN.InitializeNonceAccount, e.data);
                return {
                    noncePubkey: e.keys[0].pubkey,
                    authorizedPubkey: new C(t)
                }
            }
            static decodeNonceAdvance(e) {
                return this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 3),
                ev(eN.AdvanceNonceAccount, e.data),
                {
                    noncePubkey: e.keys[0].pubkey,
            ...
            static decodeNonceWithdraw(e) {
                ...
                let {lamports: t} = ev(eN.WithdrawNonceAccount, e.data);
                return {
                    noncePubkey: e.keys[0].pubkey,
                    toPubkey: e.keys[1].pubkey,
            ...
            static decodeNonceAuthorize(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 2);
                let {authorized: t} = ev(eN.AuthorizeNonceAccount, e.data);
                return {
                    noncePubkey: e.keys[0].pubkey,
                    authorizedPubkey: e.keys[1].pubkey,
                    newAuthorizedPubkey: new C(t)
                }
            }
        ...
        let eN = Object.freeze({
            Create: {
                index: 0,
                layout: g.w3([g.DH("instruction"), g.Wg("lamports"), g.Wg("space"), U("programId")])
            },
            Assign: {
                index: 1,
                layout: g.w3([g.DH("instruction"), U("programId")])
            },
            Transfer: {
                index: 2,
                layout: g.w3([g.DH("instruction"), eW("lamports")])
            },
            CreateWithSeed: {
                index: 3,
                layout: g.w3([g.DH("instruction"), U("base"), V("seed"), g.Wg("lamports"), g.Wg("space"), U("programId")])
            },
            AdvanceNonceAccount: {
                index: 4,
                layout: g.w3([g.DH("instruction")])
            },
            WithdrawNonceAccount: {
                index: 5,
                layout: g.w3([g.DH("instruction"), g.Wg("lamports")])
            },
            InitializeNonceAccount: {
                index: 6,
                layout: g.w3([g.DH("instruction"), U("authorized")])
            },
            ...
            Allocate: {
                index: 8,
                layout: g.w3([g.DH("instruction"), g.Wg("space")])
            },
            AllocateWithSeed: {
                index: 9,
                layout: g.w3([g.DH("instruction"), U("base"), V("seed"), g.Wg("space"), U("programId")])
            },
            AssignWithSeed: {
                index: 10,
                layout: g.w3([g.DH("instruction"), U("base"), V("seed"), U("programId")])
            },
            TransferWithSeed: {
                index: 11,
                layout: g.w3([g.DH("instruction"), eW("lamports"), V("seed"), U("programId")])
            },
            UpgradeNonceAccount: {
                index: 12,
                layout: g.w3([g.DH("instruction")])
        ...
        class eO {
            ...
            static transfer(e) {
                let t, r;
                return "basePubkey"in e ? (t = e_(eN.TransferWithSeed, {
            ...
            static assign(e) {
                let t, r;
                return "basePubkey"in e ? (t = e_(eN.AssignWithSeed, {
            ...
            static createNonceAccount(e) {
                let t = new ea;
                "basePubkey"in e && "seed"in e ? t.add(eO.createAccountWithSeed({
            ...
            static nonceInitialize(e) {
                let t = e_(eN.InitializeNonceAccount, {
            ...
            static nonceAdvance(e) {
                let t = e_(eN.AdvanceNonceAccount);
                return new en({
                    keys: [{
                        pubkey: e.noncePubkey,
                        isSigner: !1,
            ...
            static nonceWithdraw(e) {
                let t = e_(eN.WithdrawNonceAccount, {
                    lamports: e.lamports
                });
                return new en({
                    keys: [{
            ...
            static nonceAuthorize(e) {
                let t = e_(eN.AuthorizeNonceAccount, {
            ...
            static allocate(e) {
                let t, r;
                return "basePubkey"in e ? (t = e_(eN.AllocateWithSeed, {
                    base: E(e.basePubkey.toBuffer()),
                    seed: e.seed,
                    space: e.space,
                    programId: E(e.programId.toBuffer())
        ...
        eO.programId = new C("11111111111111111111111111111111");
        let eR = K - 300;
        class eC {
            constructor() {}
            static getMinNumSignatures(e) {
                return 2 * (Math.ceil(e / eC.chunkSize) + 1 + 1)
            }
            static async load(e, t, r, i, s) {
                {
                    ...
                    if (null !== a) {
                        if (a.executable)
                            ...
                            !1;
                        a.data.length !== s.length && (o = o || new ea).add(eO.allocate({
                            accountPubkey: r.publicKey,
                            space: s.length
                        })),
                        a.owner.equals(i) || (o = o || new ea).add(eO.assign({
                            accountPubkey: r.publicKey,
                            programId: i
                        })),
                        a.lamports < n && (o = o || new ea).add(eO.transfer({
                            fromPubkey: t.publicKey,
                            toPubkey: r.publicKey,
                            lamports: n - a.lamports
                        }))
                    } else
                        o = new ea().add(eO.createAccount({
                            fromPubkey: t.publicKey,
                    ...
                    null !== o && await eS(e, o, [t, r], {
                        commitment: "confirmed"
                    })
                }
                let a = g.w3([g.DH("instruction"), g.DH("offset"), g.DH("bytesLength"), g.DH("bytesLengthPadding"), g.O6(g.u8("byte"), g.cY(g.DH(), -8), "bytes")])
                  , o = eC.chunkSize
                  , c = 0
                  , u = s
                  , l = [];
                for (; u.length > 0; ) {
                    ...
                    e._rpcEndpoint.includes("solana.com") && await eI(250),
                    c += o,
                    u = u.slice(o)
                }
                await Promise.all(l);
                {
                    let s = g.w3([g.DH("instruction")])
                      , a = n.Buffer.alloc(s.span);
                    s.encode({
                        instruction: 1
                    }, a);
                    let o = new ea().add({
        ...
        eC.chunkSize = eR;
        let ex = new C("BPFLoader2111111111111111111111111111111111");
        class eL {
            static getMinNumSignatures(e) {
                return eC.getMinNumSignatures(e)
            }
            static load(e, t, r, i, s) {
                return eC.load(e, t, r, s, i)
            }
        }
        var eK = function(e) {
                ...
                var i = function r(i, s) {
                    ...
                    case "object":
                        ...
                        if ("[object Array]" === (d = e.call(i))) {
                            ...
                            a = i.length - 1; n < a; n++)
                                o += r(i[n], !0) + ",";
                            return a > -1 && (o += r(i[n], !0)),
                            o + "]"
                        }
                        if ("[object Object]" !== d)
                            return JSON.stringify(i);
                        for (a = (c = t(i).sort()).length,
                        o = "",
                        n = 0; n < a; )
                            void 0 !== (l = r(i[u = c[n]], !1)) && (o && (o += ","),
                            o += JSON.stringify(u) + ":" + l),
                            n++;
                        return "{" + o + "}";
                    case "function":
                    case "undefined":
        ...
        class eY {
            ...
            getSlotsInEpoch(e) {
                return e < this.firstNormalEpoch ? Math.pow(2, e + ez(32)) : this.slotsPerEpoch
            }
        }
        var eq = globalThis.fetch;
        class eD extends f.vE {
            constructor(e, t, r) {
                super(e => {
                    let r = (0,
                    f.kb)(e, {
        ...
        class eH {
            ...
            static deserialize(e) {
                ...
                let {addresses: i} = g.w3([g.O6(U(), r / 32, "addresses")]).decode(e.slice(56));
                return {
                    ...
                    authority: 0 !== t.authority.length ? new C(t.authority[0]) : void 0,
        ...
        let ej = {
            index: 1,
            layout: g.w3([g.DH("typeIndex"), eW("deactivationSlot"), g.I0("lastExtendedSlot"), g.u8("lastExtendedStartIndex"), g.u8(), g.O6(U(), g.cY(g.u8(), -1), "authority")])
        }
          , eU = /^[^:]+:\/\/([^:[]+|\[[^\]]+\])(:\d+)?(.*)/i
          , eM = (0,
        m.au)((0,
        ...
        m.eu)("base64")])
          , e$ = (0,
        m.au)((0,
        m.KJ)(n.Buffer), eV, e => n.Buffer.from(e[0], "base64"))
          , eF = 3e4;
        function eJ(e) {
            let t, r;
            if ("string" == typeof e)
        ...
        m.KC)([(0,
        m.KJ)(n.Buffer), tk]), (0,
        m.KC)([eV, tk]), e => Array.isArray(e) ? (0,
        m.vt)(e, e$) : e)
          , tA = (0,
        m.NW)({
            executable: (0,
        ...
        m.NW)({
            type: (0,
            m.KC)([(0,
            m.eu)("firstShredReceived"), (0,
            m.eu)("completed"), (0,
            m.eu)("optimisticConfirmation"), (0,
            m.eu)("root")]),
            slot: (0,
            m.ai)(),
            timestamp: (0,
        ...
        class rf {
            constructor(e, t) {
                ...
                this.getBlockHeight = ( () => {
                    let e = {};
                    return async t => {
                        let {commitment: r, config: i} = eJ(t)
                        ...
                        return e[n] = e[n] ?? (async () => {
                            try {
                                ...
                                m.ai)()));
                                if ("error"in t)
                                    throw new ew(t.error,"failed to get block height information");
                                return t.result
                            } finally {
                                delete e[n]
                            }
                ...
                this._rpcWsEndpoint = i || function(e) {
                    let t = e.match(eU);
                    if (null == t)
                ...
                this._rpcClient = function(e, t, r, i, s, n) {
                    let a, o, c = r || eq;
                    return null != n && console.warn("You have supplied an `httpAgent` when creating a `Connection` in a browser environment.It has been ignored; `httpAgent` is only used in Node environments."),
                    i && (o = async (e, t) => {
                    ...
                    new (b())(async (r, i) => {
                        ...
                        try {
                            let t, r = 5, a = 500;
                            for (; (t = o ? await o(e, n) : await c(e, n),
                            429 === t.status && !0 !== s) && (r -= 1,
                            0 !== r); ) {
                                ;console.error(`Server responded with ${t.status} ${t.statusText}.  Retrying after ${a}ms delay...`),
                                await eI(a),
                                a *= 2
                            }
                            let u = await t.text();
                ...
                this._rpcWebSocket = new eD(this._rpcWsEndpoint,{
                    autoconnect: !1,
                    max_reconnects: 1 / 0
                }),
            ...
            async getBalanceAndContext(e, t) {
                ...
                m.ai)()));
                if ("error"in a)
                    throw new ew(a.error,`failed to get balance for ${e.toBase58()}`);
                return a.result
            }
            ...
            async getBlockTime(e) {
                ...
                m.ai)())));
                if ("error"in r)
                    throw new ew(r.error,`failed to get block time for slot ${e}`);
                return r.result
            }
            async getMinimumLedgerSlot() {
                ...
                m.ai)()));
                if ("error"in t)
                    throw new ew(t.error,"failed to get minimum ledger slot");
                return t.result
            }
            async getFirstAvailableBlock() {
                ...
                m.vt)(e, tp);
                if ("error"in t)
                    throw new ew(t.error,"failed to get first available block");
                return t.result
            }
            async getSupply(e) {
                let t = {};
                ...
                m.vt)(r, tm);
                if ("error"in i)
                    throw new ew(i.error,"failed to get supply");
                return i.result
            }
            async getTokenSupply(e, t) {
                ...
                m.vt)(i, e0(ty));
                if ("error"in s)
                    throw new ew(s.error,"failed to get token supply");
                return s.result
            }
            async getTokenAccountBalance(e, t) {
                ...
                m.vt)(i, e0(ty));
                if ("error"in s)
                    throw new ew(s.error,"failed to get token account balance");
                return s.result
            }
            async getTokenAccountsByOwner(e, t, r) {
                let {commitment: i, config: s} = eJ(r)
                  , n = [e.toBase58()];
                "mint"in t ? n.push({
                ...
                m.vt)(o, tf);
                if ("error"in c)
                    throw new ew(c.error,`failed to get token accounts owned by account ${e.toBase58()}`);
                return c.result
            }
            async getParsedTokenAccountsByOwner(e, t, r) {
                ...
                m.vt)(n, tw);
                if ("error"in a)
                    throw new ew(a.error,`failed to get token accounts owned by account ${e.toBase58()}`);
                return a.result
            }
            async getLargestAccounts(e) {
                ...
                m.vt)(i, tS);
                if ("error"in s)
                    throw new ew(s.error,"failed to get largest accounts");
                return s.result
            }
            async getTokenLargestAccounts(e, t) {
                ...
                m.vt)(i, tb);
                if ("error"in s)
                    throw new ew(s.error,"failed to get token largest accounts");
                return s.result
            }
            async getAccountInfoAndContext(e, t) {
                ...
                m.me)(tI)));
                if ("error"in a)
                    throw new ew(a.error,`failed to get info about account ${e.toBase58()}`);
                return a.result
            }
            ...
            async getMultipleParsedAccounts(e, t) {
                ...
                m.me)(tA))));
                if ("error"in o)
                    throw new ew(o.error,`failed to get info for accounts ${s}`);
                return o.result
            }
            ...
            async getStakeActivation(e, t, r) {
                let {commitment: i, config: s} = eJ(t)
                ...
                m.vt)(a, eQ(tE));
                if ("error"in o)
                    throw new ew(o.error,`failed to get Stake Activation ${e.toBase58()}`);
                return o.result
            }
            async getProgramAccounts(e, t) {
                ...
                m.vt)(o, eQ(c));
                if ("error"in u)
                    throw new ew(u.error,`failed to get accounts owned by program ${e.toBase58()}`);
                return u.result
            }
            async getParsedProgramAccounts(e, t) {
                ...
                m.YO)(tP)));
                if ("error"in a)
                    throw new ew(a.error,`failed to get accounts owned by program ${e.toBase58()}`);
                return a.result
            }
            ...
            async confirmTransactionUsingBlockHeightExceedanceStrategy({commitment: e, strategy: {abortSignal: t, lastValidBlockHeight: r, signature: i}}) {
                ...
                ), {abortConfirmation: o, confirmationPromise: c} = this.getTransactionConfirmationPromise({
                    commitment: e,
                    signature: i
                }), u = this.getCancellationPromise(t);
                try {
                    let e = await Promise.race([u, c, a]);
                    if (e.__type === ei.PROCESSED)
                        s = e.response;
                    else
                        throw new q(i)
                } finally {
            ...
            async confirmTransactionUsingDurableNonceStrategy({commitment: e, strategy: {abortSignal: t, minContextSlot: r, nonceAccountPubkey: i, nonceValue: s, signature: n}}) {
                let a, o = !1, c = new Promise(t => {
                    let n = s
                      , a = null
                      , c = async () => {
                        try {
                            let {context: t, value: s} = await this.getNonceAndContext(i, {
                                commitment: e,
                                minContextSlot: r
                            });
                            return a = t.slot,
            ...
            async getClusterNodes() {
                ...
                m.YO)(tY)));
                if ("error"in t)
                    throw new ew(t.error,"failed to get cluster nodes");
                return t.result
            }
            async getVoteAccounts(e) {
                ...
                m.vt)(r, tD);
                if ("error"in i)
                    throw new ew(i.error,"failed to get vote accounts");
                return i.result
            }
            async getSlot(e) {
                let {commitment: t, config: r} = eJ(e)
                ...
                m.ai)()));
                if ("error"in n)
                    throw new ew(n.error,"failed to get slot");
                return n.result
            }
            async getSlotLeader(e) {
                ...
                m.Yj)()));
                if ("error"in n)
                    throw new ew(n.error,"failed to get slot leader");
                return n.result
            }
            async getSlotLeaders(e, t) {
                ...
                m.YO)(eM)));
                if ("error"in i)
                    throw new ew(i.error,"failed to get slot leaders");
                return i.result
            }
            ...
            async getSignatureStatuses(e, t) {
                ...
                m.vt)(i, tU);
                if ("error"in s)
                    throw new ew(s.error,"failed to get signature status");
                return s.result
            }
            async getTransactionCount(e) {
                ...
                m.ai)()));
                if ("error"in n)
                    throw new ew(n.error,"failed to get transaction count");
                return n.result
            }
            ...
            async getInflationGovernor(e) {
                ...
                m.vt)(r, tc);
                if ("error"in i)
                    throw new ew(i.error,"failed to get inflation");
                return i.result
            }
            async getInflationReward(e, t, r) {
                ...
                m.vt)(a, e8);
                if ("error"in o)
                    throw new ew(o.error,"failed to get inflation reward");
                return o.result
            }
            async getInflationRate() {
                ...
                m.vt)(e, tu);
                if ("error"in t)
                    throw new ew(t.error,"failed to get inflation rate");
                return t.result
            }
            async getEpochInfo(e) {
                ...
                m.vt)(s, td);
                if ("error"in n)
                    throw new ew(n.error,"failed to get epoch info");
                return n.result
            }
            async getEpochSchedule() {
                ...
                m.vt)(e, th);
                if ("error"in t)
                    throw new ew(t.error,"failed to get epoch schedule");
                let r = t.result;
                return new eY(r.slotsPerEpoch,r.leaderScheduleSlotOffset,r.warmup,r.firstNormalEpoch,r.firstNormalSlot)
            }
            async getLeaderSchedule() {
                ...
                m.vt)(e, tg);
                if ("error"in t)
                    throw new ew(t.error,"failed to get leader schedule");
                return t.result
            }
            ...
            async getRecentBlockhashAndContext(e) {
                let {context: t, value: {blockhash: r}} = await this.getLatestBlockhashAndContext(e);
                return {
                    context: t,
                    value: {
                        blockhash: r,
            ...
            async getRecentPerformanceSamples(e) {
                ...
                m.vt)(t, rd);
                if ("error"in r)
                    throw new ew(r.error,"failed to get recent performance samples");
                return r.result
            }
            async getFeeCalculatorForBlockhash(e, t) {
                ...
                m.vt)(i, rh);
                if ("error"in s)
                    throw new ew(s.error,"failed to get fee calculator");
            ...
            async getFeeForMessage(e, t) {
                ...
                m.ai)())));
                if ("error"in n)
                    throw new ew(n.error,"failed to get fee for message");
                if (null === n.result)
            ...
            async getRecentPrioritizationFees(e) {
                ...
                m.vt)(i, tl);
                if ("error"in s)
                    throw new ew(s.error,"failed to get recent prioritization fees");
                return s.result
            }
            ...
            async getLatestBlockhashAndContext(e) {
                ...
                m.vt)(s, rc);
                if ("error"in n)
                    throw new ew(n.error,"failed to get latest blockhash");
                return n.result
            }
            async isBlockhashValid(e, t) {
                ...
                m.vt)(n, ru);
                if ("error"in a)
                    throw new ew(a.error,"failed to determine if the blockhash `" + e + "`is valid");
                return a.result
            }
            async getVersion() {
                ...
                m.vt)(e, eQ(ti));
                if ("error"in t)
                    throw new ew(t.error,"failed to get version");
                return t.result
            }
            async getGenesisHash() {
                ...
                m.Yj)()));
                if ("error"in t)
                    throw new ew(t.error,"failed to get genesis hash");
                return t.result
            }
            async getBlock(e, t) {
                let {commitment: r, config: i} = eJ(t)
                ...
                try {
                    ...
                    throw new ew(e,"failed to get confirmed block")
                }
            }
            async getParsedBlock(e, t) {
                ...
                try {
                    ...
                    throw new ew(e,"failed to get block")
                }
            }
            async getBlockProduction(e) {
                ...
                m.vt)(s, to);
                if ("error"in n)
                    throw new ew(n.error,"failed to get block production information");
                return n.result
            }
            async getTransaction(e, t) {
                ...
                m.vt)(n, ra);
                if ("error"in a)
                    throw new ew(a.error,"failed to get transaction");
                let o = a.result;
                return o ? {
                    ...o,
                    transaction: {
            ...
            async getParsedTransactions(e, t) {
                ...
                return (await this._rpcBatchRequest(s)).map(e => {
                    ...
                    m.vt)(e, ro);
                    if ("error"in t)
                        throw new ew(t.error,"failed to get transactions");
                    return t.result
                }
                )
            }
            ...
            async getConfirmedBlock(e, t) {
                ...
                m.vt)(i, rs);
                if ("error"in s)
                    throw new ew(s.error,"failed to get confirmed block");
                let n = s.result;
                if (!n)
            ...
            async getBlocks(e, t, r) {
                ...
                m.ai)())));
                if ("error"in n)
                    throw new ew(n.error,"failed to get blocks");
                return n.result
            }
            async getBlockSignatures(e, t) {
                ...
                m.vt)(i, rn);
                if ("error"in s)
                    throw new ew(s.error,"failed to get block");
                let n = s.result;
                if (!n)
            ...
            async getConfirmedTransaction(e, t) {
                ...
                m.vt)(i, ra);
                if ("error"in s)
                    throw new ew(s.error,"failed to get transaction");
                let n = s.result;
                if (!n)
                    return n;
                let a = new ee(n.transaction.message)
                  , o = n.transaction.signatures;
                return {
                    ...n,
                    transaction: ea.populate(a, o)
                }
            }
            async getParsedConfirmedTransaction(e, t) {
                ...
                m.vt)(i, ro);
                if ("error"in s)
                    throw new ew(s.error,"failed to get confirmed transaction");
                return s.result
            }
            async getParsedConfirmedTransactions(e, t) {
                ...
                return (await this._rpcBatchRequest(r)).map(e => {
                    ...
                    m.vt)(e, ro);
                    if ("error"in t)
                        throw new ew(t.error,"failed to get confirmed transactions");
                    return t.result
                }
                )
            }
            ...
            async getConfirmedSignaturesForAddress2(e, t, r) {
                ...
                m.vt)(s, tB);
                if ("error"in n)
                    throw new ew(n.error,"failed to get confirmed signatures for address");
                return n.result
            }
            async getSignaturesForAddress(e, t, r) {
                ...
                m.vt)(s, tW);
                if ("error"in n)
                    throw new ew(n.error,"failed to get signatures for address");
                return n.result
            }
            async getAddressLookupTable(e, t) {
                let {context: r, value: i} = await this.getAccountInfoAndContext(e, t)
                  , s = null;
                return null !== i && (s = new eH({
                    key: e,
                    state: eH.deserialize(i.data)
                })),
                {
                    context: r,
                    value: s
            ...
            async getNonceAndContext(e, t) {
                let {context: r, value: i} = await this.getAccountInfoAndContext(e, t)
                  , s = null;
                return null !== i && (s = eB.fromAccountData(i.data)),
                {
                    context: r,
                    value: s
                }
            ...
            async requestAirdrop(e, t) {
                ...
                m.vt)(r, rg);
                if ("error"in i)
                    throw new ew(i.error,`airdrop to ${e.toBase58()} failed`);
                return i.result
            }
            async _blockhashWithExpiryBlockHeight(e) {
                if (!e) {
                    ...
                    if (null !== this._blockhashInfo.latestBlockhash && !(e >= eF))
            ...
            async getStakeMinimumDelegation(e) {
                ...
                m.ai)()));
                if ("error"in n)
                    throw new ew(n.error,"failed to get stake minimum delegation");
                return n.result
            }
            async simulateTransaction(e, t, r) {
                ...
                if ("message"in e) {
                    ...
                    t && "object" == typeof t && "innerInstructions"in t && (a.innerInstructions = t.innerInstructions);
                    let o = [s, a]
                      , c = await this._rpcRequest("simulateTransaction", o)
                      , u = (0,
                    m.vt)(c, ta);
                    if ("error"in u)
                ...
                if (e instanceof ea ? ((i = new ea).feePayer = e.feePayer,
                i.instructions = e.instructions,
                i.nonceInfo = e.nonceInfo,
                i.signatures = e.signatures) : (i = ea.populate(e))._message = i._json = void 0,
                ...
                let s = i._compile()
                  , a = s.serialize()
                  , o = i._serialize(a).toString("base64")
                  , c = {
                    encoding: "base64",
                    commitment: this.commitment
                };
                r && (c.accounts = {
                    encoding: "base64",
                    addresses: (Array.isArray(r) ? r : s.nonProgramIds()).map(e => e.toBase58())
                }),
                t && (c.sigVerify = !0),
                ...
                if ("error"in d) {
                    let e;
                    if ("data"in d.error && (e = d.error.data.logs) && Array.isArray(e)) {
                        let t = "\n    "
                          , r = t + e.join(t);
                    ...
                    if (void 0 !== r)
                        ...
                        case "unsubscribed":
                            ...
                            await (async () => {
                                ...
                                try {
                                    ...
                                    if (console.error(`Received ${ninstanceof Error ? "" : "JSON-RPC "}error calling \`${s}\``, {
                                        args: i,
                                        error: n
                                    }),
                                    !t())
                        ...
                        case "subscribed":
                            0 === r.callbacks.size && await (async () => {
                                let {serverSubscriptionId: i, unsubscribeMethod: s} = r;
                                if (this._subscriptionsAutoDisposedByRpc.has(i))
                                    ...
                                    try {
                                        ...
                                        if (i instanceof Error && console.error(`${s} error:`, i.message),
                                        !t())
                                            return;
                                        this._setSubscription(e, {
                                            ...r,
            ...
            _makeSubscription(e, t) {
                ...
                this._subscriptionDisposeFunctionsByClientSubscriptionId[r] = async () => {
                    ...
                    J(void 0 !== t, `Could not find a \`Subscription\` when tearing down client subscription #${r}`),
            ...
            onAccountChange(e, t, r) {
                let {commitment: i, config: s} = eJ(r)
                  , n = this._buildArgs([e.toBase58()], i || this._commitment || "finalized", "base64", s);
            ...
            onProgramAccountChange(e, t, r, i) {
                let {commitment: s, config: n} = eJ(r)
                  , a = this._buildArgs([e.toBase58()], s || this._commitment || "finalized", "base64", n || (i ? {
                    filters: eG(i)
                } : void 0));
                return this._makeSubscription({
                    callback: t,
        ...
        let rw = Object.freeze({
            CreateLookupTable: {
                index: 0,
                layout: g.w3([g.DH("instruction"), eW("recentSlot"), g.u8("bumpSeed")])
            },
            FreezeLookupTable: {
                index: 1,
                layout: g.w3([g.DH("instruction")])
            ...
            ExtendLookupTable: {
                index: 2,
                layout: g.w3([g.DH("instruction"), eW(), g.O6(U(), g.cY(g.DH(), -8), "addresses")])
            },
        ...
        class rS {
            ...
            static decodeInstructionType(e) {
                ...
                this.checkProgramId(e.programId);
                let r = g.DH("instruction").decode(e.data);
                for (let[e,i] of Object.entries(rw))
                    if (i.index == r) {
                        t = e;
                        break
                    }
            ...
            static decodeCreateLookupTable(e) {
                ...
                let {recentSlot: t} = ev(rw.CreateLookupTable, e.data);
                return {
            ...
            static decodeExtendLookupTable(e) {
                ...
                let {addresses: t} = ev(rw.ExtendLookupTable, e.data);
                return {
                    lookupTable: e.keys[0].pubkey,
                    authority: e.keys[1].pubkey,
                    payer: e.keys.length > 2 ? e.keys[2].pubkey : void 0,
                    addresses: t.map(e => new C(e))
                }
            }
        ...
        class rI {
            ...
            static createLookupTable(e) {
                let[t,r] = C.findProgramAddressSync([e.authority.toBuffer(), (0,
                p.eC)().encode(e.recentSlot)], this.programId)
                  , i = e_(rw.CreateLookupTable, {
            ...
            static deactivateLookupTable(e) {
                let t = e_(rw.DeactivateLookupTable)
                  , r = [{
                    pubkey: e.lookupTable,
                    isSigner: !1,
                    isWritable: !0
        ...
        rI.programId = new C("AddressLookupTab1e1111111111111111111111111");
        class r_ {
            constructor() {}
            static decodeInstructionType(e) {
                let t;
            ...
            static decodeRequestUnits(e) {
                this.checkProgramId(e.programId);
                let {units: t, additionalFee: r} = ev(rv.RequestUnits, e.data);
                return {
                    units: t,
                    additionalFee: r
                }
            ...
            static decodeRequestHeapFrame(e) {
                this.checkProgramId(e.programId);
                let {bytes: t} = ev(rv.RequestHeapFrame, e.data);
                return {
                    bytes: t
                }
            }
            static decodeSetComputeUnitLimit(e) {
                this.checkProgramId(e.programId);
                let {units: t} = ev(rv.SetComputeUnitLimit, e.data);
                return {
                    units: t
                }
            }
            static decodeSetComputeUnitPrice(e) {
                this.checkProgramId(e.programId);
                let {microLamports: t} = ev(rv.SetComputeUnitPrice, e.data);
                return {
                    microLamports: t
                }
            }
        ...
        let rv = Object.freeze({
            RequestUnits: {
                index: 0,
                layout: g.w3([g.u8("instruction"), g.DH("units"), g.DH("additionalFee")])
            },
            RequestHeapFrame: {
                index: 1,
                layout: g.w3([g.u8("instruction"), g.DH("bytes")])
            },
            SetComputeUnitLimit: {
                index: 2,
                layout: g.w3([g.u8("instruction"), g.DH("units")])
            },
            SetComputeUnitPrice: {
                index: 3,
                layout: g.w3([g.u8("instruction"), eW("microLamports")])
            }
        });
        class rA {
            constructor() {}
            static requestUnits(e) {
                let t = e_(rv.RequestUnits, e);
                return new en({
                    keys: [],
                    programId: this.programId,
                    data: t
            ...
            static requestHeapFrame(e) {
                let t = e_(rv.RequestHeapFrame, e);
                return new en({
                    keys: [],
                    programId: this.programId,
                    data: t
            ...
            static setComputeUnitLimit(e) {
                let t = e_(rv.SetComputeUnitLimit, e);
                return new en({
                    keys: [],
                    programId: this.programId,
                    data: t
            ...
            static setComputeUnitPrice(e) {
                let t = e_(rv.SetComputeUnitPrice, {
        ...
        rA.programId = new C("ComputeBudget111111111111111111111111111111");
        let rP = g.w3([g.u8("numSignatures"), g.u8("padding"), g.NX("signatureOffset"), g.NX("signatureInstructionIndex"), g.NX("publicKeyOffset"), g.NX("publicKeyInstructionIndex"), g.NX("messageDataOffset"), g.NX("messageDataSize"), g.NX("messageInstructionIndex")]);
        class rE {
            constructor() {}
            static createInstructionWithPublicKey(e) {
                let {publicKey: t, message: r, signature: i, instructionIndex: s} = e;
                J(32 === t.length, `Public Key must be 32 bytes but received ${t.length} bytes`),
                J(64 === i.length, `Signature must be 64 bytes but received ${i.length} bytes`);
                let a = rP.span
                  , o = a + t.length
                  , c = o + i.length
        ...
        rE.programId = new C("Ed25519SigVerify111111111111111111111111111");
        let rB = (e, t) => {
            let r = w.bI.sign(e, t);
        ...
        let rW = w.bI.getPublicKey
          , rT = g.w3([g.u8("numSignatures"), g.NX("signatureOffset"), g.u8("signatureInstructionIndex"), g.NX("ethAddressOffset"), g.u8("ethAddressInstructionIndex"), g.NX("messageDataOffset"), g.NX("messageDataSize"), g.u8("messageInstructionIndex"), g.av(20, "ethAddress"), g.av(64, "signature"), g.u8("recoveryId")]);
        class rN {
            constructor() {}
            ...
            static createInstructionWithPublicKey(e) {
                let {publicKey: t, message: r, signature: i, recoveryId: s, instructionIndex: n} = e;
                return rN.createInstructionWithEthAddress({
                    ethAddress: rN.publicKeyToEthAddress(t),
                    message: r,
                    signature: i,
                    recoveryId: s,
                    instructionIndex: n
            ...
            static createInstructionWithEthAddress(e) {
                let t, {ethAddress: r, message: i, signature: s, recoveryId: a, instructionIndex: o=0} = e;
                J(20 === (t = "string" == typeof r ? r.startsWith("0x") ? n.Buffer.from(r.substr(2), "hex") : n.Buffer.from(r, "hex") : r).length, `Address must be 20 bytes but received ${t.length} bytes`);
                let c = 12 + t.length
                  , u = c + s.length + 1
                  , l = n.Buffer.alloc(rT.span + i.length);
                return rT.encode({
                    numSignatures: 1,
                    signatureOffset: c,
        ...
        rN.programId = new C("KeccakSecp256k11111111111111111111111111111");
        let rO = new C("StakeConfig11111111111111111111111111111111");
        class rR {
            constructor(e, t) {
                this.staker = void 0,
        ...
        rC.default = new rC(0,0,C.default);
        class rx {
            constructor() {}
            static decodeInstructionType(e) {
                let t;
            ...
            static decodeInitialize(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 2);
                let {authorized: t, lockup: r} = ev(rL.Initialize, e.data);
                return {
                    stakePubkey: e.keys[0].pubkey,
                    authorized: new rR(new C(t.staker),new C(t.withdrawer)),
                    lockup: new rC(r.unixTimestamp,r.epoch,new C(r.custodian))
                }
            }
            static decodeDelegate(e) {
                return this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 6),
                ev(rL.Delegate, e.data),
                {
                    stakePubkey: e.keys[0].pubkey,
            ...
            static decodeAuthorize(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 3);
                let {newAuthorized: t, stakeAuthorizationType: r} = ev(rL.Authorize, e.data)
                  , i = {
                    stakePubkey: e.keys[0].pubkey,
                    authorizedPubkey: e.keys[2].pubkey,
                    newAuthorizedPubkey: new C(t),
            ...
            static decodeAuthorizeWithSeed(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 2);
                let {newAuthorized: t, stakeAuthorizationType: r, authoritySeed: i, authorityOwner: s} = ev(rL.AuthorizeWithSeed, e.data)
                  , n = {
                    stakePubkey: e.keys[0].pubkey,
                    authorityBase: e.keys[1].pubkey,
                    authoritySeed: i,
                    authorityOwner: new C(s),
                    newAuthorizedPubkey: new C(t),
                    stakeAuthorizationType: {
                        index: r
                    }
                };
                return e.keys.length > 3 && (n.custodianPubkey = e.keys[3].pubkey),
                n
            }
            static decodeSplit(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 3);
                let {lamports: t} = ev(rL.Split, e.data);
                return {
                    stakePubkey: e.keys[0].pubkey,
            ...
            static decodeWithdraw(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 5);
                let {lamports: t} = ev(rL.Withdraw, e.data)
                  , r = {
                    stakePubkey: e.keys[0].pubkey,
                    toPubkey: e.keys[1].pubkey,
                    authorizedPubkey: e.keys[4].pubkey,
        ...
        let rL = Object.freeze({
            Initialize: {
                index: 0,
                layout: g.w3([g.DH("instruction"), ( (e="authorized") => g.w3([U("staker"), U("withdrawer")], e))(), ( (e="lockup") => g.w3([g.Wg("unixTimestamp"), g.Wg("epoch"), U("custodian")], e))()])
            },
            Authorize: {
                index: 1,
                layout: g.w3([g.DH("instruction"), U("newAuthorized"), g.DH("stakeAuthorizationType")])
            },
            Delegate: {
                index: 2,
                layout: g.w3([g.DH("instruction")])
            ...
            AuthorizeWithSeed: {
                index: 8,
                layout: g.w3([g.DH("instruction"), U("newAuthorized"), g.DH("stakeAuthorizationType"), V("authoritySeed"), U("authorityOwner")])
            }
        })
          , rK = Object.freeze({
            Staker: {
        ...
        class rz {
            ...
            static createAccountWithSeed(e) {
                let t = new ea;
                t.add(eO.createAccountWithSeed({
                    fromPubkey: e.fromPubkey,
            ...
            static authorize(e) {
                let {stakePubkey: t, authorizedPubkey: r, newAuthorizedPubkey: i, stakeAuthorizationType: s, custodianPubkey: n} = e
                  , a = e_(rL.Authorize, {
            ...
            static authorizeWithSeed(e) {
                let {stakePubkey: t, authorityBase: r, authoritySeed: i, authorityOwner: s, newAuthorizedPubkey: n, stakeAuthorizationType: a, custodianPubkey: o} = e
                  , c = e_(rL.AuthorizeWithSeed, {
            ...
            static splitInstruction(e) {
                let {stakePubkey: t, authorizedPubkey: r, splitStakePubkey: i, lamports: s} = e
                  , n = e_(rL.Split, {
                    lamports: s
                });
                return new en({
            ...
            static splitWithSeed(e, t) {
                let {stakePubkey: r, authorizedPubkey: i, splitStakePubkey: s, basePubkey: n, seed: a, lamports: o} = e
                  , c = new ea;
                return c.add(eO.allocate({
                    accountPubkey: s,
                    basePubkey: n,
                    seed: a,
                    space: this.space,
            ...
            static withdraw(e) {
                let {stakePubkey: t, authorizedPubkey: r, toPubkey: i, lamports: s, custodianPubkey: n} = e
                  , a = e_(rL.Withdraw, {
                    lamports: s
                })
                  , o = [{
        ...
        rz.programId = new C("Stake11111111111111111111111111111111111111"),
        rz.space = 200;
        class rY {
            constructor(e, t, r, i) {
        ...
        class rq {
            ...
            static decodeInstructionType(e) {
                ...
                this.checkProgramId(e.programId);
                let r = g.DH("instruction").decode(e.data);
                for (let[e,i] of Object.entries(rD))
                    if (i.index == r) {
                        t = e;
                        break
                    }
            ...
            static decodeInitializeAccount(e) {
                ...
                let {voteInit: t} = ev(rD.InitializeAccount, e.data);
                return {
                    votePubkey: e.keys[0].pubkey,
                    nodePubkey: e.keys[3].pubkey,
                    voteInit: new rY(new C(t.nodePubkey),new C(t.authorizedVoter),new C(t.authorizedWithdrawer),t.commission)
                }
            }
            static decodeAuthorize(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 3);
                let {newAuthorized: t, voteAuthorizationType: r} = ev(rD.Authorize, e.data);
                return {
                    votePubkey: e.keys[0].pubkey,
                    authorizedPubkey: e.keys[2].pubkey,
                    newAuthorizedPubkey: new C(t),
            ...
            static decodeAuthorizeWithSeed(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 3);
                let {voteAuthorizeWithSeedArgs: {currentAuthorityDerivedKeyOwnerPubkey: t, currentAuthorityDerivedKeySeed: r, newAuthorized: i, voteAuthorizationType: s}} = ev(rD.AuthorizeWithSeed, e.data);
                return {
                    currentAuthorityDerivedKeyBasePubkey: e.keys[2].pubkey,
                    currentAuthorityDerivedKeyOwnerPubkey: new C(t),
                    currentAuthorityDerivedKeySeed: r,
                    newAuthorizedPubkey: new C(i),
                    voteAuthorizationType: {
                        index: s
                    },
                    votePubkey: e.keys[0].pubkey
            ...
            static decodeWithdraw(e) {
                this.checkProgramId(e.programId),
                this.checkKeyLength(e.keys, 3);
                let {lamports: t} = ev(rD.Withdraw, e.data);
                return {
                    votePubkey: e.keys[0].pubkey,
        ...
        let rD = Object.freeze({
            InitializeAccount: {
                index: 0,
                layout: g.w3([g.DH("instruction"), ( (e="voteInit") => g.w3([U("nodePubkey"), U("authorizedVoter"), U("authorizedWithdrawer"), g.u8("commission")], e))()])
            },
            Authorize: {
                index: 1,
                layout: g.w3([g.DH("instruction"), U("newAuthorized"), g.DH("voteAuthorizationType")])
            },
            Withdraw: {
                index: 3,
                layout: g.w3([g.DH("instruction"), g.Wg("lamports")])
            ...
            AuthorizeWithSeed: {
                index: 10,
                layout: g.w3([g.DH("instruction"), ( (e="voteAuthorizeWithSeedArgs") => g.w3([g.DH("voteAuthorizationType"), U("currentAuthorityDerivedKeyOwnerPubkey"), V("currentAuthorityDerivedKeySeed"), U("newAuthorized")], e))()])
            }
        })
          , rH = Object.freeze({
            Voter: {
        ...
        class rj {
            ...
            static authorize(e) {
                let {votePubkey: t, authorizedPubkey: r, newAuthorizedPubkey: i, voteAuthorizationType: s} = e
                  , n = e_(rD.Authorize, {
                    newAuthorized: E(i.toBuffer()),
            ...
            static authorizeWithSeed(e) {
                let {currentAuthorityDerivedKeyBasePubkey: t, currentAuthorityDerivedKeyOwnerPubkey: r, currentAuthorityDerivedKeySeed: i, newAuthorizedPubkey: s, voteAuthorizationType: n, votePubkey: a} = e
                  , o = e_(rD.AuthorizeWithSeed, {
            ...
            static withdraw(e) {
                let {votePubkey: t, authorizedWithdrawerPubkey: r, lamports: i, toPubkey: s} = e
                  , n = e_(rD.Withdraw, {
                    lamports: i
                });
                return new ea().add({
            ...
            static updateValidatorIdentity(e) {
                let {votePubkey: t, authorizedWithdrawerPubkey: r, nodePubkey: i} = e
                  , s = e_(rD.UpdateValidatorIdentity);
                return new ea().add({
                    keys: [{
                        pubkey: t,
                        isSigner: !1,
        ...
        rj.programId = new C("Vote111111111111111111111111111111111111111"),
        rj.space = 3762;
        let rU = new C("Va1idator1nfo111111111111111111111111111111")
          , rM = (0,
        m.NW)({
            name: (0,
            m.Yj)(),
        ...
        class rV {
            ...
            static fromConfigData(e) {
                ...
                if (r[0].publicKey.equals(rU) && r[1].isSigner) {
                    let e = JSON.parse(V().decode(n.Buffer.from(t)));
                    return (0,
                    m.vA)(e, rM),
                    new rV(r[1].publicKey,e)
                }
                return null
            }
        }
        let r$ = new C("Vote111111111111111111111111111111111111111")
          , rF = g.w3([U("nodePubkey"), U("authorizedWithdrawer"), g.u8("commission"), g.I0(), g.O6(g.w3([g.I0("slot"), g.DH("confirmationCount")]), g.cY(g.DH(), -8), "votes"), g.u8("rootSlotValid"), g.I0("rootSlot"), g.I0(), g.O6(g.w3([g.I0("epoch"), U("authorizedVoter")]), g.cY(g.DH(), -8), "authorizedVoters"), g.w3([g.O6(g.w3([U("authorizedPubkey"), g.I0("epochOfLastAuthorizedSwitch"), g.I0("targetEpoch")]), 32, "buf"), g.I0("idx"), g.u8("isEmpty")], "priorVoters"), g.I0(), g.O6(g.w3([g.I0("epoch"), g.I0("credits"), g.I0("prevCredits")]), g.cY(g.DH(), -8), "epochCredits"), g.w3([g.I0("slot"), g.I0("timestamp")], "lastTimestamp")]);
        class rJ {
            constructor(e) {
                this.nodePubkey = void 0,
                this.authorizedWithdrawer = void 0,
            ...
            static fromAccountData(e) {
                let t = rF.decode(E(e), 4)
                  , r = t.rootSlot;
                return t.rootSlotValid || (r = null),
                new rJ({
                    nodePubkey: new C(t.nodePubkey),
                    authorizedWithdrawer: new C(t.authorizedWithdrawer),
                    commission: t.commission,
                    votes: t.votes,
                    rootSlot: r,
                    authorizedVoters: t.authorizedVoters.map(rG),
                    priorVoters: function({buf: e, idx: t, isEmpty: r}) {
                        return r ? [] : [...e.slice(t + 1).map(rX), ...e.slice(0, t).map(rX)]
                    }(t.priorVoters),
        ...
        function rG({authorizedVoter: e, epoch: t}) {
            return {
                epoch: t,
                authorizedVoter: new C(e)
            }
        }
        function rX({authorizedPubkey: e, epochOfLastAuthorizedSwitch: t, targetEpoch: r}) {
            return {
                authorizedPubkey: new C(e),
        ...
        async function r0(e, t, r, i) {
            let s, n;
            r && Object.prototype.hasOwnProperty.call(r, "lastValidBlockHeight") || r && Object.prototype.hasOwnProperty.call(r, "nonceValue") ? (s = r,
            n = i) : n = r;
            let a = n && {
              ...
              , c = n && n.commitment
              , u = s ? e.confirmTransaction(s, c) : e.confirmTransaction(o, c)
              , l = (await u).value;
            if (l.err) {
                if (null != o)
                    throw new ef({
